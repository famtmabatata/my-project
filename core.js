...
const app = {
    ...
    hideSplashScreen() {
        ...
        // حماية: إذا لم تكتمل الحركة خلال 3 ثوانٍ
        setTimeout(() => {
            if (document.getElementById('splash-screen')) splash.remove();
        }, 3000);
    },
    ...
    setupPullToRefresh() {
        if (window.innerWidth > 768) return; // فقط للجوال
        let startY = 0;
        ...
        document.addEventListener('touchmove', e => {
            if (window.scrollY === 0 && e.touches[0].clientY - startY > 100) {
                ...
                startY = e.touches[0].clientY; // إعادة تعيين
            }
        }, { passive: true });
    },
    ...
    /** قائمة "المزيد" لشريط الجوال (خاص بالمدير) */
