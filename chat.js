...
export function initChatModule(app) {
    ...
    app.sendMessage = async function() {
        ...
        const msg = {
            ...
            reactions: [],
            deletedFor: [],
            readBy: [app.user.s],   // المرسل يقرأ تلقائياً
    ...
    app.renderMessages = function() {
        ...
        msgs.forEach((m, idx) => {
            ...
            // علامات القراءة للمحادثات الفردية
            let readMark = '';
    ...
    // ... (باقي الدوال: showReactionDetails, showMessageContext, copyMessage, deleteMessage, toggleReaction, renderChatList, forceLeaveGroup...)
    ...
    app.openChat = function(type, id) {
        ...
        // تعليم الرسائل كمقروءة في المحادثات الفردية
        if (type === 'user') {
